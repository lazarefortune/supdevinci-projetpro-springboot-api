...
public class AppService {
  ...
  private void initProducts() {
    ...
    product.setDescription(
        "Samsung Galaxy S8 smartphone with 4.30-inch 1440x3040 pixels display, "
    ...
    product.setDescription(
        "Apple iPhone X smartphone with 4.00-inch 1080x2340 pixels display, "
    ...
    product.setDescription(
        "Nike Air Max smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
    ...
    product.setDescription(
        "Adidas Yeezy smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
    ...
    product.setDescription(
        "Gucci Bag smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
    ...
    product.setDescription(
        "Gucci Watch smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
    ...
    product.setDescription(
        "Gucci Sunglasses smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
    ...
    product.setDescription(
        "Gucci Hat smartphone with 4.00-inch 1080x2340 pixels display, "
            + "Apple A12 Bionic chip, "
            + "64GB of internal memory, "
            + "iOS 12, "
            + "12.5 inches, "
